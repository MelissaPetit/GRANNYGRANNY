...
offer5 = Offer.create!(title: "Yamakasi avec Mamie Gertrude",
                       description:"Affrontez les sommets des grattes ciel de NewYork avec Mamie Gertrude lors d'une séance de parcours",
                       start_from: Date.today,
...
offer_sport18 = Offer.create!(title: "Initiation au saut à l'élastique avec Josée",
                        description:"Faites le grand saut avec Josée et découvrez les sensations fortes du saut à l'élastique",
                        start_from: Date.today,
